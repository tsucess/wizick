...
// tablinks[5].className = tablinks[5].className.replace(" active", "");
...
let displayCreateTemplate = document.querySelector('.in-active-10');
let btnCreateTempCancel = document.querySelector('#btn-temp-cancel');
...
btnCreateTempCancel.addEventListener('click', function(){
